  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          После разбора я наконец поняла, почему студенты уходили на третьем модуле. Оказалось — дело не в контенте, а в структуре заданий. Исправила за неделю, удержание выросло заметно.
        </blockquote>
        ...
        >
          ...
          <p className="text-sm text-primary-foreground/60 mt-1">Автор курса по нутрициологии</p>
        </div>
      </div>
    </section>
  )
